...
def train_cv_model():
    ...
    save_model = SaveModel( dump_fd=cfg.dev_md_fd+'/'+type, call_freq=10 )
    ...
    # train model
    md.fit( x=tr_X, y=tr_y, batch_size=20, n_epochs=150, loss_func='binary_crossentropy', optimizer=optimizer, callbacks=callbacks )
