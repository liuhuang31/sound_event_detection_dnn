...
def train_model():
    ...
    save_model = SaveModel( dump_fd=cfg.eva_md_fd + '/' + type, call_freq=50 )
    
    # callbacks
    callbacks = [validation, save_model]
    
    # train model
    md.fit( x=tr_X, y=tr_y, batch_size=20, n_epochs=1000, loss_func='binary_crossentropy', optimizer=optimizer, callbacks=callbacks )
